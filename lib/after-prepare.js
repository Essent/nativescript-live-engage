...
var xcodeBundleFilePath = '../../' + bundleFilePath;
	...
	return new Promise(function (resolve, reject) {
		if (fs.existsSync(lpBundle)) {
			if (platform === 'android') {
				...
				// console.dir(xcodeProject.getFirstTarget().uuid);
				var targetUuids = xcodeProject.getFirstProject()['firstProject']['targets'];

				targetUuids.forEach(function (target) {
